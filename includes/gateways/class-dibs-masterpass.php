...
class WC_Gateway_Dibs_MasterPass extends WC_Gateway_Dibs {
	...
	public function __construct() {
        ...
        $this->method_title 		= __('DIBS MasterPass', 'woocommerce-gateway-dibs-masterpass');
	...
	function enqueue_css($hook) {
		if ( 'settings_page_dibs-masterpass-admin' == $hook || 'wc_gateway_dibs_masterpass' == $_GET['section'] ) {
			wp_register_style( 'dibs-masterpass-admin', plugin_dir_url( __FILE__ ) . 'assets/css/admin.css', false );
			wp_enqueue_style( 'dibs-masterpass-admin' );
		}
	}
	...
	public function admin_options() {
    	...
    	<div class="dibs-account-settings">
	    	<div class="dibs-account-settings-content">
			...
			<div class="dibs-account-settings-sidebar">
				<?php
				include( WC_DIBS_PLUGIN_DIR . 'views/settings-info.php' );
				?>
			</div>
		</div>
    	<?php
